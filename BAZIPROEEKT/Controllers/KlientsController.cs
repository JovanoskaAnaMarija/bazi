...
namespace BAZIPROEEKT.Controllers
{
    public class KlientsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id_klient,ime,username,password,email")] Klient klient)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id_klient,ime,username,password,email")] Klient klient)
        {
            if (ModelState.IsValid)
            {
